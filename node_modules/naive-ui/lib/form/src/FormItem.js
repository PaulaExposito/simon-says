...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const mergedDisabledRef = NForm ? (0, vue_1.toRef)(NForm, 'disabled') : (0, vue_1.ref)(false);
        ...
        const internalValidate = (trigger = null, shouldRuleBeApplied = () => true, options = {
            ...
            const value = NForm ? (0, lodash_1.get)(NForm.model, path, null) : undefined;
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign({ mergedClsPrefix: mergedClsPrefixRef, mergedRequired: mergedRequiredRef, hasFeedback: hasFeedbackRef, feedbackId: feedbackIdRef, explains: explainsRef }, formItemMiscRefs), formItemSizeRefs), exposedRef), { cssVars: (0, vue_1.computed)(() => {
                var _a;
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            mergedShowLabel && (this.label || $slots.label) ? ((0, vue_1.h)("label", { class: `${mergedClsPrefix}-form-item-label`, style: this.mergedLabelStyle },
                mergedRequireMarkPlacement !== 'left'
                    ? (0, vue_1.renderSlot)($slots, 'label', undefined, () => [this.label])
                    : null,
                (mergedShowRequireMark !== undefined
                    ? mergedShowRequireMark
                    : this.mergedRequired) ? ((0, vue_1.h)("span", { class: `${mergedClsPrefix}-form-item-label__asterisk` }, mergedRequireMarkPlacement !== 'left' ? '\u00A0*' : '*\u00A0')) : null,
                mergedRequireMarkPlacement === 'left'
                    ? (0, vue_1.renderSlot)($slots, 'label', undefined, () => [this.label])
                    : null)) : null,
            (0, vue_1.h)("div", { class: [
            ...
            this.mergedShowFeedback ? ((0, vue_1.h)("div", { key: this.feedbackId, class: `${mergedClsPrefix}-form-item-feedback-wrapper` },
                (0, vue_1.h)(vue_1.Transition, { name: "fade-down-transition", mode: "out-in" }, {
                    default: () => {
                        const feedbacks = ((0, vue_1.h)(Feedbacks_1.default, { clsPrefix: mergedClsPrefix, explains: this.explains, feedback: this.feedback }));
                        const { hasFeedback, mergedValidationStatus } = this;
                        return hasFeedback ? (mergedValidationStatus === 'warning' ? ((0, vue_1.h)("div", { key: "controlled-warning", class: `${mergedClsPrefix}-form-item-feedback ${mergedClsPrefix}-form-item-feedback--warning` }, feedbacks)) : mergedValidationStatus === 'error' ? ((0, vue_1.h)("div", { key: "controlled-error", class: `${mergedClsPrefix}-form-item-feedback ${mergedClsPrefix}-form-item-feedback--error` }, feedbacks)) : mergedValidationStatus === 'success' ? ((0, vue_1.h)("div", { key: "controlled-success", class: `${mergedClsPrefix}-form-item-feedback ${mergedClsPrefix}-form-item-feedback--success` }, feedbacks)) : ((0, vue_1.h)("div", { key: "controlled-default", class: `${mergedClsPrefix}-form-item-feedback` }, feedbacks))) : null;
                    }
                }))) : null));
    }
});
